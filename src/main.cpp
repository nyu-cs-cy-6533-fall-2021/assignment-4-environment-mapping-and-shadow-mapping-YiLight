...
int main() {
    ...
    const GLchar* fragment_shader =
            "#version 150 core\n"
                    ...
                    "    outColor = (10 * cosTheta/(length(light_to_vertex_camera)*length(light_to_vertex_camera)) + 0.2) * vec4(base_color, 1.0);"
                    "}";
